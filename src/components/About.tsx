  ...
  return (
    <div className="bg-[#121212] pb-[3rem] pt-[4rem] md:pt-[8rem]">
      <div className="grid grid-cols-1 md:grid-cols-2 w-[80%] mx-auto gap-[3rem] items-center">
        <div>
          <h1 className="text-[20px] font-bold uppercase text-[#556e65] mb-[1rem]">
            ABOUT ME
          </h1>
        ...
        <div className="mb-[3rem] flex items-center md:space-x-10">
          ...
          <p className="text-[19px] text-slate-300 w-[80%]">
            Lorem ipsum dolor, sit amet consectetur adipisicing elit. Culpa, cupiditate itaque provident dolore inventore suscipit optio vel doloribus consequatur nesciunt rem earum.
          </p>
        </div>
